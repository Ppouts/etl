-- Nombre de fois où la pièce ciblée change avant d'avoir été atteinte
-- (un changement de cible causé par le ramassage effectif de la précédente ne compte pas).
with ordered as (
    select
        run_id,
        step_index,
